...
def main():
    ...
    export_cfg = settings.get("export_csv", {}) or {}
    try:
        export_every = int(export_cfg.get("refill_export_every", 1))
    except Exception:
        export_every = 1
    ...
    try:
        for code in codes:
            ...
            try:
                ...
                if export_every > 0 and processed_in_this_run % export_every == 0:
                    # Export DB to CSV periodically during refill
